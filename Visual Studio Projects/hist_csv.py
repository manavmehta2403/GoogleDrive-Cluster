...
def main():
    ...
    try:
        ...
        choice = int(input("Enter the option you want to analyze: "))
        ##cheching whether the user input in the specific range
        if (1 <= choice <= 3):
            pass
        else:
            print("\nPlease enter the correct option\n")
            main() #calling recurssively the options
            
    #catch the try block
    except:
        print("\nPlease enter the correct option\n")
        main()# calling the recursive way for menu if try dont execute
    ...
    #performing the operation for the choice 1
    if (choice == 1):
